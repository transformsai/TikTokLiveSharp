...
namespace TikTokLiveSharpNetCoreWPFTestApp
{
    /// <summary>
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            OpenConsole();
            Console.WriteLine($"Connecting to: {ifHostId.Text}");
            TikTokLiveClient client = new TikTokLiveClient(ifHostId.Text, "", new ClientSettings()
            {
