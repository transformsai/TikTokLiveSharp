...
{
    [ProtoContract]
    public partial class BusinessContent : AProtoBase
    {
        ...
        {
            get => oneofBusinessCase.Is(100) ? (CohostContent)oneofBusinessCase.Object : default;
            private set => oneofBusinessCase = new DiscriminatedUnion64Object(200, value);
        }
    }
}
