...
namespace TikTokLiveSharp.Events.Data
{
    public sealed class P2PGroupChangeContent
    {
        ...
        {
            GroupExtInfoList = content?.GroupExtInfoList is { Count: > 0 } ? content.GroupExtInfoList.Select(i => (RTCExtraInfo)i).ToList().AsReadOnly() : new List<RTCExtraInfo>(0).AsReadOnly();
        }
